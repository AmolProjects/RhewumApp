...
////            dateValue = dateFormat.format(this.SummeryList.get(i).measurementDate);
////            viewholder.date_tv.setText(dateValue);
////            Log.d("DateVAlue","ViewHolderDate "+dateValue);
////        } else {
////            viewholder.date_tv.setText("N/A"); // Or any default text
////        }
//
//        //added new
//        if (this.SummeryList.get(i).measurementDate != null) {
...
//                public void onClick(View view) {
//                    Intent intent = new Intent(VibCheckerArchiveAdapter.this.mContext, VibChecker_ListActivity.class);
//                    // Pass the float values as extras
//                    intent.putExtra("replace2", replace2);
//                    intent.putExtra("valueYaxis", valueYaxis);
//                    intent.putExtra("valueZaxis", valueZaxis);
//                    intent.putExtra("dominantFreqX", dominantFreqX);
...
//                    Log.d("DateVAlue", "PutIntent" +dateValue);
//
//                    // Existing ID extra
...
//    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        //added for buffer
        // Added validation for sensorData
        // Inside getView method


// Rest of the intent passing code remains unchanged...
