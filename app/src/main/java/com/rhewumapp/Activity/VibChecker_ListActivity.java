...
//        txty.setText(String.format(Locale.US, "Y: %.2f", valueYaxis));
//        txtZZ.setText(String.format(Locale.US, "Z: %.2f", valueZaxis));
//        txtfrZ.setText(String.format(Locale.US, "Z: %.2f", zDominantFrequency));
//        txtfrx.setText(String.format(Locale.US, "X: %.2f", xDominantFrequency));
//        txtfry.setText(String.format(Locale.US, "Y: %.2f", yDominantFrequency));
            ...
            public void onClick(View view) {
                ...
                if (!vibCheckerSummaryDaoArrayLists.isEmpty()) {
                    ...
                    File csvFile = new File(getCacheDir() + "/" + getResources().getString(R.string.psd_summary) + ".csv");
                     try {
                        saveVibCheckerDataToCSV((context), (ArrayList<RawDao>) vibCheckerSummaryDaoArrayLists, csvFile);
